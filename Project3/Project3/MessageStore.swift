...
func voteThing(completion: @escaping (Error?, [ChatMessage]?) -> Void) {
    var fullURL = baseURL + "/like/5ea61f397172487c85c272db"
    fullURL = fullURL + "?key=" + key + "&client=" + client// + "&limit=20"
